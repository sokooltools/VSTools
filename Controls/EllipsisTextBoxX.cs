...
//
// Note: This control is also dependent on the NativeMethods class.
//===========================================================================================================
...
namespace SokoolTools.VsTools
{
	...
	/// </summary>
	//----------------------------------------------------------------------------------------------------------------------------
	internal sealed class EllipsisTextBox : TextBox
	{
		//..................................................................................................................................
		...
		private int _expansionLineCount = 5;
		...
		[Category("Misc"), Description("The number of lines to show when the expand button (down-arrow) is clicked."
			+ " [Default=5]")]
		public int ExpansionLineCount
		{
			get => _expansionLineCount;
			set => _expansionLineCount = value;
		}
		...
		public new string Text
		{
			...
			set
			{
				...
				base.Text = HideSelection && !Focused ? _ellipsisText : _fullText;
			}
		}
		...
		{
			if (_btnExpText == null && _expansionLineCount > 1)
			{
		...
		{
			if (_expansionLineCount > 1 && RectangleToScreen(ClientRectangle).Contains(Cursor.Position))
				return;
		...
		private void SetEllipsisText()
		{
			...
			if (idx > -1) _ellipsisText = _ellipsisText.Remove(idx);
		}
