...
namespace SokoolTools.VsTools
{
	...
	/// commands is selected by the user, and so it can be considered the main entry point for the integration with the IDE.
	/// Notice that this implementation derives from Microsoft.VisualStudio.Shell.Package that is the basic implementation of 
	/// a package provided by the Managed Package Framework (MPF).
	/// </summary>
	//----------------------------------------------------------------------------------------------------------------------------
	[PackageRegistration(UseManagedResourcesOnly = true, AllowsBackgroundLoading = true)]
	[Guid("8CCE8876-C155-4A94-95A3-EF619E2D2736")]
	[InstalledProductRegistration("#110", "#112", "3.0.1.61", IconResourceID = 400)]
	...
	public sealed class VsToolsPackage : AsyncPackage
	{
		...
		//------------------------------------------------------------------------------------------------------------------------
		/// <summary>
		/// Initialization of the package; this method is called right after the package is sited, so this is the place where you 
		/// can put all the initialization code that rely on services provided by VisualStudio.
		/// </summary>
