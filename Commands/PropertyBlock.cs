...
namespace SokoolTools.VsTools
{
	...
	internal static class PropertyBlock
	{
		...
		public static void Expand()
		{
			...
			// This should never really happen.
			if (!(Connect.DteService.ActiveWindow.Document.Selection is TextSelection sel))
				throw new ApplicationException("No text was selected!");

			// NOTE for this to work requires the document to be part of a loaded project.
			CodeElement codeProperty =
				Connect.DteService.ActiveDocument.ProjectItem.FileCodeModel.CodeElementFromPoint(sel.ActivePoint, vsCMElement.vsCMElementProperty);
		...
		public static void CodeElementExample()
		{
            ...
            try
			{
				var sel = (TextSelection)Connect.DteService.ActiveDocument.Selection;
